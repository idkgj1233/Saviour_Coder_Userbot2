...
async def repo(e):
    res = [
        await e.builder.article(
            title="Saviour_Coder-Userbot",
            description="Userbot | Telethon",
            thumb=wb(ultpic, 0, "image/jpeg", []),
            text="• **Saviour_Coder-USERBOT** •",
            buttons=[
                [Button.url("Repo", url="https://github.com/idkgj1233/Saviour_Coder_Userbot2")],
                [Button.url("Support", url="https://t.me/ubuntu_coders")],
            ],
        )
    ]
    await e.answer(res)
